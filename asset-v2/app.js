 ...
 */
var app=new function(){this.name="Abloom",this.version="2",this.date="2024",this.folder="asset-v2/",this.looptime=8e3,this.bpm=120,this.totalframe=384,this.nbpolo=7,this.nbloopbonus=2,this.bonusloopA=!0,this.bonusendloopA=!1,this.recmaxloop=23,this.recminloop=3,this.recmintime=Math.round(this.looptime/1e3)*this.recminloop,this.spritepolo="polo-sprite.png",this.spritepicto="game-picto.png",this.colBck="#914678",this.col0="#000000",this.col1="#ff45ef",this.col2="#bf19a6",this.col3="#880094",this.col4="#620b73",this.animearray=[
    {name:"1_MrHihatty",color:"f70fbd",uniqsnd:!0},
    {name:"2_MrKicky",color:"f70fbd",uniqsnd:!1},
    {name:"3_MrSnarey",color:"f70fbd",uniqsnd:!0},
    {name:"4_MrWhateverTheHellThisIs",color:"f70fbd",uniqsnd:!0},
    {name:"5_MrCloppy",color:"f70fbd",uniqsnd:!0},
    {name:"6_MrBassy",color:"1286e6",uniqsnd:!1},
    {name:"7_MrChordstacky",color:"1286e6",uniqsnd:!0},
    {name:"8_MrDropletty",color:"1286e6",uniqsnd:!0},
    {name:"9_MrWindchimey",color:"1286e6",uniqsnd:!1},
    {name:"Melvin",color:"1286e6",uniqsnd:!1},
    {name:"11_MrDewy",color:"08eb08",uniqsnd:!1},
    {name:"12_MrHooey",color:"08eb08",uniqsnd:!1},
    {name:"13_MrPianoey",color:"08eb08",uniqsnd:!1},
    {name:"14_MrWhistley",color:"08eb08",uniqsnd:!1},
    {name:"15_MrHarpy",color:"08eb08",uniqsnd:!1},
    {name:"16_MrWaity",color:"edcb0b",uniqsnd:!1},
    {name:"17_MrShiny",color:"edcb0b",uniqsnd:!1},
    {name:"18_MrChoirey",color:"edcb0b",uniqsnd:!1},
    {name:"19_MrLonely",color:"edcb0b",uniqsnd:!1},
    {name:"20_MrGiggityQuagmireLasagnaAIDS",color:"edcb0b",uniqsnd:!1}
],this.bonusarray=[
    {name:"b1-The_Garden",src:"b1-The_Garden.mp4",code:"2,4,6,12,20",sound:"b1-The_Garden",aspire:"b1-aspire"},
    {name:"b2-The_Rainbow",src:"b2-The_Rainbow.mp4",code:"5,6,8,17,18",sound:"b2-The_Rainbow",aspire:"b2-aspire"},
    {name:"b3-The_Dawning",src:"b3-The_Dawning.mp4",code:"4,6,11,13,16",sound:"b3-The_Dawning",aspire:"b3-aspire"},],this.unlockerarray=[];for(var n=0,o=this.animearray.length;n<o;n++){var a=this.animearray[n].name;this.animearray[n].soundA=a+"_a",this.animearray[n].soundB=this.animearray[n].uniqsnd?a+"_a":a+"_b",this.animearray[n].anime=a+"-sprite.png",this.animearray[n].animeData=a+".json"}};